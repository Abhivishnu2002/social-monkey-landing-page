      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <motion.div 
            ...
            className="flex flex-col gap-10 max-w-xl mx-auto lg:mx-0"
          >
            <div>
          ...
          >
            <div className="glass-card bg-[#11052C]/60 border-[#7B2CFF]/30 p-8 md:p-10 rounded-[2rem] shadow-2xl relative overflow-hidden w-full">
        ...
        <motion.div 
          ...
          className="mt-24 glass-card bg-[#11052C]/60 border-[#7B2CFF]/30 p-8 md:p-12 rounded-[2rem] flex flex-col lg:flex-row items-center justify-between gap-8 w-full"
        >
          <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
            ...
            <div>
              ...
              <p className="text-white/70 text-sm max-w-sm mx-auto md:mx-0">Get updates on our launch, exclusive offers, and curated events.</p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-auto flex-1 max-w-md mx-auto lg:mx-0">
            <div className="flex flex-col sm:flex-row gap-0 rounded-xl overflow-hidden border border-white/10 bg-[#05010F]/50 focus-within:border-[#7B2CFF] focus-within:shadow-[0_0_15px_rgba(123,44,255,0.2)] transition-all">
              ...
              />
              <button className="bg-gradient-to-r from-[#7B2CFF] to-[#FF2EA6] text-white font-bold uppercase text-xs tracking-wider px-8 py-4 hover:brightness-110 transition-all whitespace-nowrap">
                NOTIFY ME
              </button>
            </div>
          </div>
